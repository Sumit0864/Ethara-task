    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-[#000000] text-[#EDEDF0] font-sans selection:bg-white/20">
      <div className="w-full max-w-[380px] p-6">
        ...
        <div className="text-center mb-10">
          <h1 className="text-[22px] font-semibold tracking-tight text-white mb-2">Create an account</h1>
          <p className="text-[#888888] text-sm">Enter your details to get started with TaskFlow.</p>
        </div>
